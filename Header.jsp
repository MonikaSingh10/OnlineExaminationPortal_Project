	...
	<div class="navbar navbar-inverse set-radius-zero">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand"> <img src="images/exam.png"
					 height=70px width=250px alt="Online Examination">
				</a>
				...
				<div class="col-md-12">
					<div class="navbar-collapse collapse ">
						<ul id="menu-top" class="nav navbar-nav navbar-right">
							...
							<li><a id="homeMenu" href="Home.jsp" class="menu-top-active">HOME</a></li>
							<!-- <li><a href="Test.jsp">EXAMINATION</a></li> -->
							<li><a href="selStream.jsp">EXAMINATION</a></li>
						</ul>
					</div>
				</div>
